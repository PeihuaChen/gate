 ...
 * 
 *  auto generated: Wed Oct 24 17:24:06 2001
 *
 *  $Id$
 *
 */
...
CREATE OR REPLACE VIEW V_ANNOTATION_FEATURES (set_id, annotation_id, FT_KEY, FT_VALUE_TYPE, FT_NUMBER_VALUE, FT_CHARACTER_VALUE, FT_LONG_CHARACTER_VALUE, FT_BINARY_VALUE)  AS
       SELECT T_AS_ANNOTATION.ASANN_AS_ID, T_AS_ANNOTATION.ASANN_ANN_ID, T_FEATURE.FT_KEY, T_FEATURE.FT_VALUE_TYPE, T_FEATURE.FT_NUMBER_VALUE, T_FEATURE.FT_CHARACTER_VALUE, T_FEATURE.FT_LONG_CHARACTER_VALUE, T_FEATURE.FT_BINARY_VALUE
       FROM T_AS_ANNOTATION, T_FEATURE
       WHERE          ft_entity_id = asann_ann_id
and   ft_entity_type = 3;


DROP VIEW V_ANNOTATION;

CREATE OR REPLACE VIEW V_ANNOTATION (ANN_ID, AT_NAME, start_offset, end_offset, ASANN_AS_ID)  AS
       SELECT T_ANNOTATION.ANN_ID, T_ANNOTATION_TYPE.AT_NAME, s_node.NODE_OFFSET, e_node.NODE_OFFSET, T_AS_ANNOTATION.ASANN_AS_ID
       FROM T_AS_ANNOTATION, T_ANNOTATION, T_ANNOTATION_TYPE, T_NODE s_node, T_NODE e_node
       WHERE       asann_ann_id=ann_id
and ann_at_id=at_id
