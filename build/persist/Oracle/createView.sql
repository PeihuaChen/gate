 ...
 * 
 *  auto generated: Mon Oct 29 14:57:48 2001
 *
 *  $Id$
 *
 */
...
CREATE OR REPLACE VIEW V_DOCUMENT AS
       SELECT T_DOCUMENT.DOC_CONTENT_ID, T_DOCUMENT.DOC_LR_ID, T_DOCUMENT.DOC_ID, T_DOCUMENT.DOC_URL, T_DOCUMENT.DOC_START, T_DOCUMENT.DOC_END, T_DOCUMENT.DOC_IS_MARKUP_AWARE, T_LANG_RESOURCE.LR_ID, T_LANG_RESOURCE.LR_NAME, T_LR_TYPE.LRTP_TYPE
...
CREATE OR REPLACE VIEW V_ANNOTATION_FEATURES (ANN_LOCAL_ID, set_id, FT_KEY, FT_VALUE_TYPE, FT_NUMBER_VALUE, FT_CHARACTER_VALUE, FT_LONG_CHARACTER_VALUE, FT_BINARY_VALUE)  AS
       SELECT T_ANNOTATION.ANN_LOCAL_ID, T_AS_ANNOTATION.ASANN_AS_ID, T_FEATURE.FT_KEY, T_FEATURE.FT_VALUE_TYPE, T_FEATURE.FT_NUMBER_VALUE, T_FEATURE.FT_CHARACTER_VALUE, T_FEATURE.FT_LONG_CHARACTER_VALUE, T_FEATURE.FT_BINARY_VALUE
       FROM T_AS_ANNOTATION, T_FEATURE, T_ANNOTATION
