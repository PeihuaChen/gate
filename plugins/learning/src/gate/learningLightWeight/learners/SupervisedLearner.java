...
/**
 * The abstract class for supervised binary learner. The implemented
 * class is SvmLibSVM.java so far.
 */
public abstract class SupervisedLearner {
  /** Learner's name. */
  private static String learnerName;
  /** The executable name of the learner, which is used
   * for the learner as the external executable. 
   * Not suitable for the SvmLibSVM.java, because it is
  ...
  /** Does use the parameter tau to adjust the 
   * numeric output of svm.
   */
  boolean isUseTau = true;
  /** Does use the parameter tau to 
   * adjust the numeric output of svm.
   */
