...
import shef.nlp.buchart.mapping.*;
...
public class Chart
{
	...
	public Chart(Long id, Long begin, Long end)
	{
		...
		try
		{
			...
			buchartCategory = BrillToBuchart.convertBrillToBuchart("TOP");
	...
	public void setNextPos(String brillCat, Long beginPos, Long endPos, String stringValue, String root, String affix, String text )
	{
		...
		try
		{
			buchartCategory = BrillToBuchart.convertBrillToBuchart(brillCat);
	...
	public void setFinal()
	{
		...
		try
		{
			buchartCategory = BrillToBuchart.convertBrillToBuchart("BOTTOM");
			edge = new InitialEdge(new Long(value++), new Long(value),
	...
	public static String toBuchartFormat(ArrayList list)
	{
		String output = "";
		InitialEdge edge;
...
public Chart(Long id, Long begin, Long end, BuChartRecord topCategory) {
InitialEdge edge;
long value;
   sentence_ID = id;
   beginOffset = begin;
 ...
 public void setFinal(BuChartRecord bottomCategory) {
 ...
 public void setNext(BuChartRecord record) {
  ...
  * @return
  */
 public String toBuchartFormat(Hashtable featureTable) {
  InitialEdge edge;
  String output = "chart(sentence_n:";
  output += sentence_ID.toString()+",";
  ...
  {
          edge = (InitialEdge) ite.next();
          output += edge.toBuChartFormat(featureTable)+",\n\n";
