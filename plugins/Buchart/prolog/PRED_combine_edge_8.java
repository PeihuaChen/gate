 ...
 * @procedure combine_edge/8 in buchart.pl
 */
...
class PRED_combine_edge_8_1 extends PRED_combine_edge_8 {
    ...
    public Predicate exec(Prolog engine) {
        ...
        p2 = new PRED_$dummy_buchart46pl_1_15(a1, a2, a3, a4, a6, a7, a8, a10, a11, a12, a13, a14, new VariableTerm(engine), new VariableTerm(engine), new VariableTerm(engine), p1);
