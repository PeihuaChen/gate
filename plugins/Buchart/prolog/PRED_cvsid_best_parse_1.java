...
public class PRED_cvsid_best_parse_1 extends Predicate {
    ...
    static IntegerTerm s26 = new IntegerTerm(103);
    static IntegerTerm s27 = new IntegerTerm(105);
    ...
    static ListTerm s43 = new ListTerm(s26, s42);
    static ListTerm s44 = new ListTerm(s12, s43);
    static ListTerm s45 = new ListTerm(s8, s44);
