...
?- non_interactive, save_program('buchart.sicstus', parse), flush_output, halt(0).


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% $Log$
% Revision 1.1  2004/12/08 11:32:32  niraj
% adding buchart source from horacio
%
