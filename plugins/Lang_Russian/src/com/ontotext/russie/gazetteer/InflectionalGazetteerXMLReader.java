...
// Source File Name:   InflectionalGazetteerXMLReader.java
    ...
    implements RussIEConstants, ContentHandler
{
        ...
        throws SAXException
    {
        ...
        if(localName.equals("tag"))
        {
            ...
            if(type.charAt(0) == 'N' && type.charAt(type.length() - 1) == 'n' || type.charAt(0) == 'V' && type.charAt(type.length() - 1) == 'i')
