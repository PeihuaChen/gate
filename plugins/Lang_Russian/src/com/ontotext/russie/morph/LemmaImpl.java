 ...
 * with their morpho-syntactic types.
 * NOTE: The current implementation considers that the types are distinct
 * in a single lemma.
 * <p>Title: RussIE</p>
...
public class LemmaImpl implements Lemma{
  ...
  public void setAnnotationType (String type) { annotationType=type;  }
  ...
  /**
   * It is needed to adjust inflation suffixes while dynamically building the root.
   * adds to the suffixes in the internal representation.
   ...
   * wf according to this new root. Accordingly adjusts the other suffixes in the
   * lemma if the root changes.
   * @param wf the new word-form
...
/**
 * Calculates the difference between the specified name and this lemma in terms of
 * finding a common root and returns the count of characters different at the
 * suffix of the name compared to the lemma.
 * @param name
 * @return
 */
