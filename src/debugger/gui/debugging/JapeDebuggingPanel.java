...
import debugger.gui.*;
import debugger.gui.debugging.debugviews.*;
import debugger.resources.*;
import debugger.resources.pr.*;
 ...
 */
public class JapeDebuggingPanel extends JPanel {
...
//        panel.add(selectedTextPane, c);
    ...
    public void setText(int startOffset, int endOffset, Document document) {
        ...
        try {
            this.selectedTextPane.setText(document.getContent().getContent(new Long(startOffset), new Long(endOffset)).toString());
