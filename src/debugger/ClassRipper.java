...
public class ClassRipper {
	/** Assumed as debug level between 0 (lowest or no debug) and 5 (highest) */
	...
	/**
	 * Obtains field from given class instance regardless either this field
	 * private or not
	 * 
	 * @param classInstance
	...
	/**
	 * Obtains method from the given class instance regardless either this field
	 * private or not.
	 * 
	 * @param classInstance
	 *            class instance which value to extract
