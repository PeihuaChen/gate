...
DROP FUNCTION persist_create_annotation(int4,int4,int4,int4,int4,int4,int4,varchar);
CREATE FUNCTION persist_create_annotation(int4,int4,int4,int4,int4,int4,int4,varchar) RETURNS int4 AS '
