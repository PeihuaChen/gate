...
public class IndexWriter {
  ...
  /**
   * Default value is 10.  Use <code>gate.creole.annic.apache.lucene.mergeFactor</code>
   * system property to override.
   */
  public static final int DEFAULT_MERGE_FACTOR =
    Integer.parseInt(System.getProperty("gate.creole.annic.apache.lucene.mergeFactor",
      "10"));

  /**
   * Default value is 10.  Use <code>gate.creole.annic.apache.lucene.minMergeDocs</code>
   * system property to override.
   */
  public static final int DEFAULT_MIN_MERGE_DOCS =
    Integer.parseInt(System.getProperty("gate.creole.annic.apache.lucene.minMergeDocs",
      "10"));

  /**
   * Default value is {@link Integer#MAX_VALUE}.
   * Use <code>gate.creole.annic.apache.lucene.maxMergeDocs</code> system property to override.
   */
  public static final int DEFAULT_MAX_MERGE_DOCS =
    Integer.parseInt(System.getProperty("gate.creole.annic.apache.lucene.maxMergeDocs",
      String.valueOf(Integer.MAX_VALUE)));

  /**
   * Default value is 10000.  Use <code>gate.creole.annic.apache.lucene.maxFieldLength</code>
   * system property to override.
   */
  ...
  */
   ...
   * Since Documents are merged in a {@link gate.creole.annic.apache.lucene.store.RAMDirectory},
