...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(172.749, 256.96277);
((GeneralPath)shape).quadTo(173.92868, 257.26746, 174.54196, 258.02136);
((GeneralPath)shape).quadTo(175.15524, 258.77527, 175.15524, 259.93933);
((GeneralPath)shape).quadTo(175.15524, 261.6737, 173.82712, 262.57605);
((GeneralPath)shape).quadTo(172.499, 263.4784, 169.95212, 263.4784);
((GeneralPath)shape).quadTo(169.05368, 263.4784, 168.15134, 263.33386);
((GeneralPath)shape).quadTo(167.249, 263.18933, 166.36618, 262.90027);
((GeneralPath)shape).lineTo(166.36618, 260.57996);
((GeneralPath)shape).quadTo(167.20993, 261.00183, 168.04196, 261.21667);
((GeneralPath)shape).quadTo(168.874, 261.43152, 169.67868, 261.43152);
((GeneralPath)shape).quadTo(170.874, 261.43152, 171.51071, 261.01746);
((GeneralPath)shape).quadTo(172.14743, 260.6034, 172.14743, 259.82996);
((GeneralPath)shape).quadTo(172.14743, 259.03308, 171.49509, 258.62292);
((GeneralPath)shape).quadTo(170.84274, 258.21277, 169.5693, 258.21277);
((GeneralPath)shape).lineTo(168.36618, 258.21277);
((GeneralPath)shape).lineTo(168.36618, 256.27527);
((GeneralPath)shape).lineTo(169.6318, 256.27527);
((GeneralPath)shape).quadTo(170.76462, 256.27527, 171.3193, 255.9198);
((GeneralPath)shape).quadTo(171.874, 255.56433, 171.874, 254.83777);
((GeneralPath)shape).quadTo(171.874, 254.1659, 171.33493, 253.7987);
((GeneralPath)shape).quadTo(170.79587, 253.43152, 169.8115, 253.43152);
((GeneralPath)shape).quadTo(169.08493, 253.43152, 168.34274, 253.59558);
((GeneralPath)shape).quadTo(167.60056, 253.75964, 166.86618, 254.07996);
((GeneralPath)shape).lineTo(166.86618, 251.87683);
((GeneralPath)shape).quadTo(167.7568, 251.62683, 168.6318, 251.50183);
((GeneralPath)shape).quadTo(169.5068, 251.37683, 170.35056, 251.37683);
((GeneralPath)shape).quadTo(172.624, 251.37683, 173.7529, 252.12292);
((GeneralPath)shape).quadTo(174.8818, 252.86902, 174.8818, 254.36902);
((GeneralPath)shape).quadTo(174.8818, 255.39246, 174.34274, 256.0448);
((GeneralPath)shape).quadTo(173.80368, 256.69714, 172.749, 256.96277);
((GeneralPath)shape).closePath();
paint = new Color(0, 128, 0, 255);
g.setPaint(paint);
g.fill(shape);
