...
public class InstanceAction extends AbstractAction implements
	...
	public void actionPerformed(ActionEvent actionevent) {
		...
		int j = JOptionPane.showOptionDialog(null, panel, "New Instance: ", 2,
		...
		if (j == 0) {
			...
			if (ontology.getInstanceByName(instanceName.getText()) != null) {
				JOptionPane.showMessageDialog(null, (new StringBuilder())
						.append("Instance :").append(instanceName.getText())
						.append(" already exists").toString());
				return;
			}
			OInstanceImpl oinstanceimpl = new OInstanceImpl(instanceName
					.getText(), comment.getText(), hashset, ontology);
