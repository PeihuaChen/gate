...
public class TransitivePropertyAction extends AbstractAction implements
  ...
  public TransitivePropertyAction(String s, Icon icon) {
    ...
    domainB.addActionListener(new ActionListener() {
      ...
      {
        this$0 = TransitivePropertyAction.this;
      }
    });
  ...
  public void actionPerformed(ActionEvent actionevent) {
    ...
    int i = JOptionPane.showOptionDialog(null, panel,
            "New Transitive Property", 2, 3, null,
    ...
    if(i == 0) {
      ...
      ObjectProperty dp = ontology.addTransitiveProperty(new URI(nameSpace
              .getText()
