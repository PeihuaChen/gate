...
public class QueryParser
  ...
  Locale locale = Locale.getDefault();
      ...
      /** Parses a query string, returning a {@link gate.creole.annic.apache.lucene.search.Query}.
   *  @param query  the query string to be parsed.
   *  @param field  the default field for query terms.
   *  @param analyzer   used to find terms in the query text.
   *  @throws ParseException if the parsing fails
   */
  static public Query parse(String query, String field, Analyzer analyzer) throws
      ParseException {
  ...
  protected Query getFieldQuery(String field,
    ...
    Vector v = new Vector();
    gate.creole.annic.apache.lucene.analysis.Token t;
    ...
    while (true) {
      ...
      if (t == null)
        break;
      /*Niraj commen this */v.addElement(t.termText());/*End*/
      /*Niraj enable this v.addElement(t); End*/
    }
    try {
      source.close();
    }
    ...
    if (v.size() == 0)
      ...
      /* Niraj add this gate.creole.annic.apache.lucene.analysis.Token temp = (gate.creole.annic.apache.lucene.analysis.Token) v.elementAt(0); End */
          /*Niraj Add this return new TermQuery(new Term(field, temp.termText(), temp.type(), temp.getPositionIncrement())); */
      ...
      for (int i = 0; i < v.size(); i++) {
        /*Niraj Add this gate.creole.annic.apache.lucene.analysis.Token temp = (gate.creole.annic.apache.lucene.analysis.Token) v.elementAt(0);
        q.add(new Term(field, temp.termText(), temp.type(), temp.getPositionIncrement())); End */
        q.add(new Term(field, (String) v.get(i)));
      }
      return q;
    }
  }
   ...
   * @exception ParseException throw in overridden method to disallow
   */
  protected Query getFuzzyQuery(String field, String termStr) throws
      ParseException {
    Term t = new Term(field, termStr);
  ...
  public static void main(String[] args) throws Exception {
    QueryParser qp = new QueryParser("field",
                                     new gate.creole.annic.apache.lucene.analysis.
                                     SimpleAnalyzer());
...
// *   Clause ::= ["+", "-"] [<TERM> ":"] ( <TERM> | "(" Query ")" )
    ...
    switch ( (jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      ...
      case NUMBER:
        ...
        if (wildcard) {
          ...
          /* Niraj Add this q = getFieldQuery(field, analyzer, termImage); */
        }
        else if (prefix) {
  ...
  private static void jj_la1_0() {
    jj_la1_0 = new int[] {
        0x180, 0x180, 0xe00, 0xe00, 0x1f31f80, 0x8000, 0x1f31000, 0x1320000,
        0x40000, 0x40000, 0x8000, 0x18000000, 0x2000000, 0x18000000, 0x8000,
        0x80000000, 0x20000000, 0x80000000, 0x8000, 0x80000, 0x8000, 0x1f30000, };
  }
