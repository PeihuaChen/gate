...
public final class StandardFilter extends TokenFilter
   ...
   */
  public final gate.creole.annic.apache.lucene.analysis.Token next() throws java.io.IOException {
    gate.creole.annic.apache.lucene.analysis.Token t = input.next();
	...
	(text.endsWith("'s") || text.endsWith("'S"))) {
      return new gate.creole.annic.apache.lucene.analysis.Token
