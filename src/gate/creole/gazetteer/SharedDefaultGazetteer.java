 ...
 *
 * The reccommended way to multithread a gate pipeline is to have a seperate
 * instance per thread (or a resource pool).  This is not ideal when using
 ...
 * this PR when embedding GATE within another application and initialise it
 * specifically. There is no reason a DefaultGazetteer loaded via a .gapp file
 * cannot be used to bootstrap this PR however.
 *
 * @author Matt Nathan
 */
public class SharedDefaultGazetteer extends DefaultGazetteer {
     ...
     * existing gazetteer.  Note that this method <i>deliberately</i> does not
     * call <code>super.init()</code> as to do so would cause the lists to be
     * reloaded.
     */
    @Override
    public Resource init() throws ResourceInstantiationException {
        ...
        this.gazetteerFeatureSeparator = bootstrapGazetteer.gazetteerFeatureSeparator;
