...
public class TClassImpl extends OntologyResourceImpl implements TClass {
  ...
  public void addSubClass(TClass subClass) {
    ...
    OntologyModificationEvent ome = new OntologyModificationEvent(ontology,
            this, OntologyModificationEvent.SUB_CLASS_ADDED_EVENT);
  ...
  public void addSuperClass(TClass superClass) {
    ...
    ontology.setModified(true);
    OntologyModificationEvent ome = new OntologyModificationEvent(ontology,
            this, OntologyModificationEvent.SUPER_CLASS_ADDED_EVENT);
    ontology.fireOntologyModificationEvent(ome);
  }
  ...
  public void removeSubClass(TClass subClass) {
    ...
    OntologyModificationEvent ome = new OntologyModificationEvent(ontology,
            this, OntologyModificationEvent.SUB_CLASS_REMOVED_EVENT);
    ontology.fireOntologyModificationEvent(ome);
    ontology.setModified(true);
  }
  ...
  public void removeSuperClass(TClass superClass) {
    ...
    OntologyModificationEvent ome = new OntologyModificationEvent(ontology,
            this, OntologyModificationEvent.SUPER_CLASS_REMOVED_EVENT);
    ontology.fireOntologyModificationEvent(ome);
    ontology.setModified(true);
  }
  ...
  public ArrayList getSubClassesVSDistance() {
    ...
    while(rollon) {
      /*
       * iterate over all the classes in levelSet and infre their subclasses in
       * set
       */
      set = new HashSet();
