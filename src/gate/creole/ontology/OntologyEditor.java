...
public interface OntologyEditor extends VisualResource {
   ...
   *          ontology comment
   */
  public void createOntology(String name, String sourceURI, String theURL,
          String comment) throws ResourceInstantiationException;
  ...
  /**
   * Adds Sub Class given a ClassNode and the resulting info from the Add Sub
   * Class dialog.
   * 
   * @param root
   *          the node which is root to the sub class being added
   * @param className
   *          the name from the dialog
   * @param classComment
   *          the comment from the dialog
   */
  ...
  /**
   * Selects an ontology. Is called when an ontology has been selecte from the
   * ontology list.
   * 
   * @param o
  ...
  /**
   * Invokes a Save As dialog for this ontology and saves it to the specified
   * location.
   * 
   * @param o
   *          the ontology to be saved
   * @param x
   *          the x coordinate of the save as dialog
   * @param y
   *          the y coordinate of the save as dialog
   */
  public void saveAsOntology(Taxonomy o, int x, int y)
          throws ResourceInstantiationException;
   ...
   * 
   * @param o
   *          the ontology to be renamed
   * @param x
   *          the x coordinate of the rename dialog
   * @param y
   *          the y coordinate of the rename dialog
   */
  public void renameOntology(Taxonomy o, int x, int y);

  /**
   * Deletes an ontology. Invokes AreYouSureDialog if the ontology has been
   * changed.
   * 
   * @param o
   *          the ontology to be deleted
   * @param x
   *          x coordinate of the option pane to be invoked
   * @param y
  ...
  /**
   * Closes an ontology. Invokes AreYouSureDialog if the ontology has been
   * changed.
   * 
   * @param o
   *          the ontology to be closed
   * @param x
   *          x coordinate of the option pane to be invoked
   * @param y
   *          y coordinate of the option pane to be invoked
   ...
   * 
   * @param o
   *          the ontology to be saved or not
   * @param x
   *          x coordinate of the option pane to be invoked
   * @param y
   *          y coordinate of the option pane to be invoked
   ...
   * 
   * @param x
   *          the x coordinate of the invocation
   * @param y
   *          the y coordinate of the invocation
   * @throws ResourceInstantiationException
   *           if something goes wrong with the loading.
   */
  public void fileOpen(int x, int y) throws ResourceInstantiationException;

  /**
   * Invoke a mutiple selection save dialog with a list of ontologies to be
   * saved.
   * 
   * @param x
   *          coords of the dialog
   ...
   *          coords of the dialog
   * @param ontologies
   *          the list of ontologies to be optionally saved
   */
  public void fileSave(int x, int y, Vector ontologies);

  /**
   * Invokes a mutiple selection close dialog with a list of ontologies to be
   * closed.
   * 
   * @param x
   *          coords of the dialog
   ...
   *          coords of the dialog
   * @param ontologies
   *          the list of ontologies to be optionally closed
   */
