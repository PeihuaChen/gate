...
/**Implements a state of the deterministic finite state machine of the
  *tokeniser.
  *It differs from {@link FSMState FSMState} by the definition of the transition
  *function which in this case maps character types to other states as oposed to
  *the transition function from FSMState which maps character types to sets of
  *states, hence the nondeterministic character.
...
//      }
  ...
  /**Sets the right hand side associated with this state. The RHS is represented
    *as a string value that will be parsed by the {@link #buildTokenDesc()}
    *method being converted in a table of strings with 2 columns and as many
    *lines as necessary.
