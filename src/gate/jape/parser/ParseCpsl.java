...
public class ParseCpsl implements JapeConstants, ParseCpslConstants {
  ...
  public ParseCpsl(String cpslFileName) throws IOException {
    this(
      new FileReader((new File(cpslFileName)).getAbsolutePath())
    );
          ...
          if(fromResource) { // the grammar is from a resource file
            ...
            try {
              ...
              { if (true) throw(new ParseException(
                                      "Can't open resource "+dirName+resName));}
            }
  ...
  final public SinglePhaseTransducer SinglePhaseTransducer()
  ...
  Rule newRule = null;
    ...
    case priority:
      ...
      try { rulePriority=Integer.parseInt(priorityTok.image); }
        ...
        Err.println("bad priority spec(" + priorityTok.image +
    ...
    try { rhs.createActionClass(); } catch(JapeException e)
    {
      ...
      { if (true) throw
        new ParseException("couldn't create rule RHS: " + e.toString()); }
    }
   ...
   */
  final public void ConstraintGroup(LeftHandSide lhs, ConstraintGroup cg)
                                                        throws ParseException {
  ...
  final public PatternElement PatternElement(LeftHandSide lhs)
                                                        throws ParseException {
  PatternElement pat = null;
  ...
  boolean macroRef = false;
    ...
    case ident:
      ...
      if(macro == null)
        { if (true) throw(
          new ParseException("unknown macro name " + macroRefTok.image));}
  ...
  // BasicPatternElement
  final public ComplexPatternElement ComplexPatternElement(LeftHandSide lhs)
                                                        throws ParseException {
  ...
  ConstraintGroup cg = new ConstraintGroup();
    ...
    if(kleeneOpTok != null) {
      ...
      if(k.equals("*"))         kleeneOp = KLEENE_STAR;
        ...
        Err.println("ignoring uninterpretable Kleene op " + k);
    }
    ...
    switch(attrValTok.kind) {
      ...
      case integer:
        try {
          ...
          Err.println("couldn't parse integer " +
      ...
      case floatingPoint:
        try {
          ...
          Err.println("couldn't parse float " +
  ...
  final public RightHandSide RightHandSide(String phaseName, String ruleName,
                                      LeftHandSide lhs) throws ParseException {
    ...
    if(block[0] != null)
      if(bindingNameSet.get(block[0]) == null) {
        { if (true) throw(new ParseException("unknown label in RHS action: "
                                                                  + block[0]));}
      }
    ...
    while (true) {
      ...
      case colon:
        ...
        nameTok = jj_consume_token(ident);
          ...
          "        " + existingAnnotSetName + ".get(\"" + existingAnnotType
          + "\");" + nl +
          ...
          "            features.put(\"" + existingAttrName +
          "\",existingFeatureValue);" + nl +
          "            break;" + nl +
          "          }" + nl + "        } // while" + nl +
  ...
  final private int[] jj_la1_0 = {0x400,0x1000,0x800000,0x1800,0x800000,
    0x2000,0x800000,0x4000,0x18000,0x18000,0x20000,0x84800000,0x80a00000,
    0x20000000,0x80a00000,0x80a00000,0x40000000,0x80200000,0x80000,0x900000,
    0x4000000,0x40000,0x10000000,0x1f00000,0x40000000,0x84800000,0x4000000,
    0x800000,0x5f00000,0x40000000,};

  final private int[] jj_la1_1 = {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
    0x20,0x2,0x0,0x2,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20,0x20,0x0,
    0x0,0x0,};
